...
public class GrfGeneratorWindow
{
	...
	private void initEvents()
	{
		...
		blacknessSpinner.addChangeListener(e -> setBlackness((int) blacknessSpinner.getValue()));

		blacknessSlider.addChangeListener(e -> setBlackness((int) blacknessSlider.getValue()));

		btnSaveGrf.addActionListener(e -> saveGrfOutput());

		btnSaveZpl.addActionListener(e -> saveZplOutput());
		...
		newWidthSpinner.addChangeListener(e -> {
		...
		newHeightSpinner.addChangeListener(e -> {
            if (resolutionsSpinnerLock)
            {
                return;
            }
	...
	{
		SwingUtilities.invokeLater(() -> generateAndSaveFiles(OutputType.ZPL));
	}

	private void saveGrfOutput()
	{
		SwingUtilities.invokeLater(() -> generateAndSaveFiles(OutputType.GRF));
	}
